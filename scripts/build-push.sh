...
retry_command "Docker Build" docker build \
  --build-arg ROOTFS_ARTIFACT_URL="https://github.com/lingosandi/mono-sandbox/releases/download/1.0.4/ubuntu-rootfs.ext4.zst" \
  -t ghcr.io/lingosandi/mono-sandbox:1.0.4 \
...
retry_command "Push 1.0.4" docker push ghcr.io/lingosandi/mono-sandbox:1.0.4
